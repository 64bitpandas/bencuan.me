...
<<<<<<< Updated upstream
<img src="/img/research/rs_plane.png" style="max-width: 747px;" />
=======
...
<<<<<<< Updated upstream
<img src="/img/research/rs_city2.png" style="max-width: 400px; border-radius: 5px;" />
=======
...
<<<<<<< Updated upstream
<img src="/img/research/rs_bridges.png" style="max-width: 600px;" />
=======
...
<FootnoteRef n="6" client:idle>And, somewhat relatedly, the rise of 'agentic AI' as a design pattern. But that's a topic for future post. :)</FootnoteRef>
...
- [City of the Witch: Enchantment, Terror, and Deliverance in the City of Love](https://www.goodreads.com/book/show/12352452-season-of-the-witch): historical accounts from San Francisco's cultural revolution of the 60's and 70's; pride, drugs, hippies, rock & roll, political assassinations, and much more.
...
<<<<<<< Updated upstream
<div style="display: flex; gap: 0.25rem; flex-wrap: wrap; justify-content: flex-start;">
=======
...
<<<<<<< Updated upstream
<img src="/img/research/rs_sunset.png" style="max-width: 400px; border-radius: 5px;" />
=======
...
<iframe src="https://bencuan.substack.com/embed" width="480" height="150" style="border:1px solid #EEE; background:white; display:block; margin:0 auto;" frameborder="0" scrolling="no"></iframe>
